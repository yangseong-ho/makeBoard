module.exports = function(app) {
    ...
    app.get('/', function(req, res) {
        ...
        var communityTopList = mysqlDbc.query('community', 'selectCommunityTop', {
            limitCnt: 10
        });

        var boardBestList = mysqlDbc.query('board', 'selectIndexBoardBest', {
            createdAt: prev7DayDateStr,
            startIndex: 0,
            limitCnt: 4
        });
        var boardNewList = mysqlDbc.query('board', 'selectIndexBoardNew', {
            createdAt: prev7DayDateStr,
            startIndex: 0,
            limitCnt: 4
        });
        ...
        res.render('index/index', {
            title: 'Regam',
            communityTopList: communityTopList,
            boardBestList: boardBestList,
